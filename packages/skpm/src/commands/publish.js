  ...
  async handler(argv) {
    ...
    if (!argv.skipRelease) {
      ...
      if (notarization) {
        ...
        console.warn(
          `\n\n⚠️ The plugin won't be notarized because the configuration is missing. It is a requirement if the plugin contains a native obj-c framework or bundled binaries on macOS 10.15. If you don't use any of those (or don't know what it is), please ignore this warning.\nFor more information about how to set up the notarization process and what it means, check https://developer.sketch.com/plugins/notarize-plugins.\n\n`
        )
      }

...
const WebpackHeaderFooterPlugin = require('./webpackHeaderFooterPlugin')
const SketchCommandPlugin = require('./sketchCommandPlugin')
...
function getCommands(output, commandIdentifiers, sketchVersion) {
  return commandIdentifiers.map(commandIdentifier => {
    let command
...
module.exports = function getWebpackConfig(
  ...
  return function webpackConfig(
    ...
    return objectAssign(
      {
        module: {
          rules: [imageLoader, babelLoader(userDefinedBabelConfig)],
        },
        resolve: {

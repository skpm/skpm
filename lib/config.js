...
var DEFAULT_CONFIG = {
  pluginPath: require('os').homedir() + '/Library/Application Support/com.bohemiancoding.sketch3/Plugins/',
...
module.exports = {
  get: function () {
    ...
    return Object.assign({}, DEFAULT_CONFIG, yaml.safeLoad(fs.readFileSync(CONFIG_PATH, 'utf8')))
  },
